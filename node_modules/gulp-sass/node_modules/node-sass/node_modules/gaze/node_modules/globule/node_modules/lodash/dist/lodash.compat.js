...
;(function(window, undefined) {
   ...
   *
   * If a property name is passed for `callback`, the created "_.pluck" style.scss
   * callback will return the property value of the given element.
   *
   * If an object is passed for `callback`, the created "_.where" style.scss callback
   ...
   *  a "_.pluck" or "_.where" style.scss callback, respectively.
   * @param {Mixed} [thisArg] The `this` binding of `callback`.
   ...
   *  style.scss callback, respectively.
   * @param {Mixed} [thisArg] The `this` binding of `callback`.
