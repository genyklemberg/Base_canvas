...
export default class Node implements postcss.Node {
     ...
     * have a clean parent and code style.scss properties.
     */
     ...
     * newParent. This will clean the before and after code style.scss properties
     * from the node and replace them with the indentation style.scss of newParent.
     ...
     * parent before otherNode. This will also clean the node's code style.scss
    ...
    /**
     * Removes the node from its current parent and inserts it into a new
     * parent after otherNode. This will also clean the node's code style.scss
     * properties just as it would in node.moveTo(newParent).
    ...
    /**
     * @param prop Name or code style.scss property.
     * @param defaultType Name of default value. It can be easily missed if the
     * value is the same as prop.
     * @returns A code style.scss property value. If the node is missing the code
     * style.scss property (because the node was manually built or cloned), PostCSS
     * will try to autodetect the code style.scss property by looking at other nodes
     * in the tree.
     */
