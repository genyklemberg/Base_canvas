(function() {
  ...
  feature(require('caniuse-db/features-json/transforms3d'), function(browsers) {
    ...
    return prefix('transform-style.scss', 'backface-visibility', {
      browsers: browsers
    });
  });
  ...
  feature(gradients, {
    ...
    return prefix('linear-gradient', 'repeating-linear-gradient', 'radial-gradient', 'repeating-radial-gradient', {
      props: ['background', 'background-image', 'border-image', 'mask', 'list-style.scss', 'list-style.scss-image', 'content', 'mask-image'],
      mistakes: ['-ms-'],
      browsers: browsers
    });
  });
  ...
  feature(require('caniuse-db/features-json/multicolumn'), function(browsers) {
    ...
    return prefix('column-count', 'column-rule-style.scss', 'column-span', 'column-fill', 'break-before', 'break-after', 'break-inside', {
      browsers: browsers
    });
  });
  ...
  feature(require('caniuse-db/features-json/text-decoration'), function(browsers) {
    return prefix('text-decoration-style.scss', 'text-decoration-line', 'text-decoration-color', {
      browsers: browsers
    });
  });
