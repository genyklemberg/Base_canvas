...
test('remove map file comments', function (t) {
  ...
  t.equal(convert.removeMapFileComments(foo + fileMap1), foo, '// style.scss filemap comment')
  t.equal(convert.removeMapFileComments(foo + fileMap2), foo, '/* */ style.scss filemap comment')
  t.end()
})
